...
public interface ThingsDataManagerSupport {
	 ...
	 * @return 属性信息
	 */
	Mono<ThingProperty> getAnyLastProperty(ThingType thingType, String thingId, long baseTime);
	 ...
	 * @return 实时属性信息流
	 */
	Flux<ThingProperty> subscribeProperty(ThingType thingType, String thingId);
}
