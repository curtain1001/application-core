...
import net.pingfang.core.metadata.ConfigMetadata;
import net.pingfang.core.metadata.DeviceMetadataType;
...
public class StaticExpandsConfigMetadataSupplier implements ExpandsConfigMetadataSupplier {
	 ...
	 * @return this
	 */
	public StaticExpandsConfigMetadataSupplier addConfigMetadata(DeviceMetadataType metadataType, String typeId,
			ConfigMetadata configMetadata) {
	...
	@Override
	public Flux<ConfigMetadata> getConfigMetadata(DeviceMetadataType metadataType, String metadataId,
			String dataTypeId) {
		return Flux.merge(Flux.fromIterable(metadata.getOrDefault("any:any", Collections.emptyList())),
				...
				Flux.fromIterable(metadata.getOrDefault(String.join(":", metadataType.name(), dataTypeId),
